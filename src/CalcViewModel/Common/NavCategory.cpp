...
static constexpr array<const NavCategoryGroupInitializer, 3> s_categoryGroupManifest = {
    ...
    NavCategoryGroupInitializer { CategoryGroupType::Weather,  L"WeatherModeTextCaps",  L"WeatherModeText", L"WeatherModePluralText" }
};
...
static constexpr int WINDCHILL_ID   = 17;
static constexpr int SUN_ID         = 18;
// ^^^ THESE CONSTANTS SHOULD NEVER CHANGE ^^^

// The order of items in this list determines the order of items in the menu.
static constexpr array<const NavCategoryInitializer, 19> s_categoryManifest = {
    ...
    NavCategoryInitializer { ViewMode::Windchill,   WINDCHILL_ID,   L"Wind Chill",      L"Weather_Windchill",        L"\uF770", CategoryGroupType::Weather,    MyVirtualKey::None,    SUPPORTS_ALL },
    NavCategoryInitializer { ViewMode::Sun,         SUN_ID,         L"Sun",             L"Weather_Sun",              L"\uE706", CategoryGroupType::Weather,    MyVirtualKey::None,    SUPPORTS_ALL }
};
...
bool NavCategory::IsWeatherViewMode(ViewMode mode)
{
    return IsModeInCategoryGroup(mode, CategoryGroupType::Weather);
}
...
IObservableVector<NavCategoryGroup^>^ NavCategoryGroup::CreateMenuOptions()
{
    ...
    menuOptions->Append(CreateWeatherCategory());
    return menuOptions;
}
...
NavCategoryGroup^ NavCategoryGroup::CreateWeatherCategory()
{
    return ref new NavCategoryGroup(s_categoryGroupManifest.at(2));
}
